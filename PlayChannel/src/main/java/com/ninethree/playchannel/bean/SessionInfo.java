...
public class SessionInfo implements Serializable {
    ...
    public com.ninethree.playchannel.bean.ReturnObject getReturnObject() {
        return ReturnObject;
    }

    public void setReturnObject(com.ninethree.playchannel.bean.ReturnObject returnObject) {
