...
import com.ninethree.playchannel.util.RegexUtil;
...
public class LoginActivity extends BaseActivity {
    ...
    private class LoginGuidTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (null != result) {
                AppUtil.setCookies(getApplicationContext(),"http://shop.93966.net/h5user/card/mycard","ULSID="+result+mUser.getUserID()+";Max-Age=2592000;Domain=.93966.net;Path=/");
